...
class V1AppCreateRequest(object):
    ...
    def __init__(self, app_classification_id=None, desc=None, introduction=None, logo=None, name=None, publish_type=None, tags=None, local_vars_configuration=None):  # noqa: E501
