...
class V1alpha1Plugin(object):
    ...
    @property
    def id(self):
        """Gets the id of this V1alpha1Plugin.  # noqa: E501


        :return: The id of this V1alpha1Plugin.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this V1alpha1Plugin.


        :param id: The id of this V1alpha1Plugin.  # noqa: E501
        :type: int
        """
